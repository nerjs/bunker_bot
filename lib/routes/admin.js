...
editAdmins.leave(ctx => ctx.reply('leave')) // TODO: Убрать сообщение
editAdmins.hears(MLC_BACK, sceneEnter(SCENE_ADMIN_PANEL))
editAdmins.hears(/\@(?<username>\w+)/, inputEditAdmins)
editAdmins.action(ACTION_ADMIN_EDIT_CONFIRM, onlyCanEditAdmins, confirmEditAdmins)
editAdmins.action(ACTION_ADMIN_EDIT_CONFIRM_S, onlyCanEditAdmins, confirmEditAdmins)
editAdmins.action(ACTION_ADMIN_EDIT_CANCEL, onlyCanEditAdmins, cancelEditAdmins)
